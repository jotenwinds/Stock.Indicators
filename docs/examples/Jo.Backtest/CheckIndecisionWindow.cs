...
internal sealed class CheckIndecisionWindow
{
    ...
    internal sealed class CheckIndecisionResult
    {
        ...
        public List<JoCandleResult> Matches;
    }
    ...
    public static CheckIndecisionResult Run(string ticker)
    {
        ...
        IStooqQuote stookQuotes1day = Program.GetHistoryFromFeed(ticker, Period._daily);
    ...
    public static CheckIndecisionResult Run(IStooqQuote stookQuotes)
    {
         ...
         *  
         */
        var results = new CheckIndecisionResult { Ticker = stookQuotes.Ticker, Matches = new List<JoCandleResult>() };
        ...
        if (resultsList.Any())
        {
            ...
            for (int i = 1; i < resultsList.Count; i++)
            {
                ...
                if (r.Match != Skender.Stock.Indicators.Match.None)
                {
